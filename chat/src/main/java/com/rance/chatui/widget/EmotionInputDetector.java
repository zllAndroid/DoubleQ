...
//                String string="{\"ctn\":\"IM\", \"mtn\":\"bindUid\",\"data\":[{\"user_id\":\"1\",\"msg\":\"shabi\"}]}";
                String ed = mEditText.getText().toString().trim();
                String string;
                if (isFirst)
                 string="{\"ctn\":\"IM\", \"mtn\":\"bindUid\",\"data\":[{\"user_id\":\"600\",\"msg\":\""+ed+"\"}]}";
                else
                 string="{\"ctn\":\"IM\", \"mtn\":\"chatUser\",\"data\":[{\"user_id\":\"500\",\"msg\":\""+ed+"\"}]}";
                MyWebSocketService.sendMsg(string);
                messageInfo.setContent(ed);
