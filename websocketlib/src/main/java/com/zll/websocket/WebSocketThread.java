        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MessageType.ReCONNECT:
                    Log.d(TAG, "WebSocket-----------------------------ReCONNECT----------------------- "+(String) msg.obj);
//                    mReconnectManager.performReconnectBind((String) msg.obj);
                    send((String) msg.obj);
                    break;
                case MessageType.CONNECT:
                    Log.d(TAG, "WebSocket-----------------------------重连----------------------- "+(String) msg.obj);
                    connect();
                    break;
                ...
                case MessageType.RECEIVE_MESSAGE:
                    ...
                    Log.d(TAG, "WebSocket---------------------------------------------------- "+(String) msg.obj);
                    break;
                        ...
                        mWebSocket = new WebSocketClient(new URI(connectUrl), new Draft_6455()) {
                            ...
                            public void onOpen(ServerHandshake handShakeData) {
                                ...
                                if (mSocketListener != null) {
                                    ...
                                    mSocketListener.onWantConnect(null);
                                }
                            }
...
//                                disconnect();
//                                mSocketListener.onDisconnected();
                                mSocketListener.onConnectError(ex);
                            }
                        };
