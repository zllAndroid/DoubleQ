...
// * 修改备注：
// */
//public class PresenterApp22 implements IWebSocketPage {
//
//    Context mContext;
//    AppView appView;
//        public PresenterApp22(Context mContext, AppView appView)
//    {
...
//String message1=message.getResponseText();
...
//        }
//        DealDataByApp.synData(mContext,message1,realmHelper,realmChatHelper,realmGroupChatHelper);
