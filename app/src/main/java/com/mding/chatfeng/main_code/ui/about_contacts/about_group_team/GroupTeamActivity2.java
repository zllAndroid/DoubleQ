...
//位置：群聊成员
public class GroupTeamActivity2 extends BaseActivity  {
...
//                initABCByGroup();
    ...
    private void initGroupTeamAdapter() {
        final GroupTeamMemberAdapter groupTeamAdapter = new GroupTeamMemberAdapter(GroupTeamActivity2.this, allCusList);
