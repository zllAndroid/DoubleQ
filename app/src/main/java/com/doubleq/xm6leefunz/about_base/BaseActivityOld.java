...
public class BaseActivityOld extends AbsWebSocketActivity {
...
//        DialogUtils.isShow();
    ...
    // TODO  接websocket 是要打开的
    @Override
    public void onMessageResponse(Response message) {
        String s = HelpUtils.HttpIsSucess(message.getResponseText());
        if ( s.equals(AppAllKey.CODE_OK))
        {
            receiveResultMsg(message.getResponseText());
        }
    }
